...
namespace Portfolio
{
    public static class Setup
    {
        ...
        static Setup()
        {
            ...
            Project ForcePong = new Project("Force Pong", "/Media/Tiles/forcePong", "For this project, I was assigned as part of a small team, to make a game using OpenGL. So ultimately we decided to make a simple pong game, but with the twist of being able to control the ball while it's moving across the screen. Both players can move it in both directions and it's actually a lot of fun. For this project, I worked on implementing the controls as well as all of the physics programming and collisions. The GitHub can be viewed <a href='https://github.com/Raccoon-Studios/Main-Game' target='_blank'>here</a>.");
            ...
            BlueVoid.SkillList.Add("UI Design");
